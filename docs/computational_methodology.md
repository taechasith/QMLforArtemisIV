...
audits. Registered development-only model fitting is authorized only after the
Gate 5 runner preserves the D004 literature-hardening diagnostics; calibration
remains restricted to post-selection calibration, and final tests remain
separately locked.
