...
| 5. Development and algorithm trigger | Generate and validate unlocked payloads, run only preregistered development analysis, and test whether the residual-QML trigger passes | In progress: D003 generator repair authorized; later authorize one new-model variant or reject algorithm invention | Pre-D003 F0 run invalid and excluded; machine-readable audit and RFIG-002 through RFIG-004 retained; corrected F0/F1/F2 and trigger report pending |
