...
| 3. Simulator credibility | Implement F0/F1/F2 dynamics, mass depletion, events, crew constraints, numerical verification, GMAT comparison, and held-out validation | Approve the simulator for dataset generation or stop/repair | In progress: credibility report and automated tests |
