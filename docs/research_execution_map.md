...
| 7. Claims and release | Build release-support cards, finish manuscript, perform robustness and negative-result analysis, audit reproducibility, prepare archive, and publish only after human approval | Accept or reject each main claim and public release | D027-C drafted Results/Discussion, result tables, and RFIG-046. Remaining work: model/simulation/data/limitation cards, reproducibility audit, release decision, tag, and archive |
