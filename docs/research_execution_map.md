...
| 7. Claims and release | Finish manuscript, perform robustness and negative-result analysis, audit reproducibility, prepare archive, and publish only after human approval | Accept or reject each main claim and public release | D030-C clean reproducibility correction PASS: the corrected clean clone passed pytest, ruff, and compileall. RFIG-049 records the PASS. Remaining work: final claim review, release decision, tag, and archive |
