...
| 7. Claims and release | Finish manuscript, perform robustness and negative-result analysis, audit reproducibility, prepare archive, and publish only after human approval | Accept or reject each main claim and public release | D028-C created model/simulator/data/limitation cards and RFIG-047. Remaining work: clean reproducibility audit, release checklist, final claim review, release decision, tag, and archive |
