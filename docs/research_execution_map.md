...
| 5. Development and algorithm trigger | Generate and validate unlocked payloads, run only preregistered development analysis, and test whether the residual-QML trigger passes | In progress: D003 G01 checkpoint qualified; later authorize one new-model variant or reject algorithm invention | Pre-D003 F0 excluded; RFIG-002 through RFIG-006 retained; corrected G01 valid, remaining F0/F1/F2 and trigger report pending |
