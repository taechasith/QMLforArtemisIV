...
| 7. Claims and release | Draft results and discussion from D026-C, perform robustness and negative-result analysis, audit reproducibility, prepare paper, archive, and GitHub release | Accept or reject each main claim and public release | D026-C created manuscript claim synthesis, `paper/manuscript.md`, and RFIG-045. Remaining work: full manuscript drafting, model/simulation/data cards, reproducibility audit, release decision, tag, and archive |
