...
| 5X. Exploratory protocol | Freeze a post-Gate-5 exploratory implementation for Q01b projected quantum kernel and FQK feasibility-only quantum kernel only | D008 accepted 2026-07-13; implementation and synthetic validation authorized; research-data execution unauthorized | The D008 YAML, implementation-freeze document, 30-row paired manifest, future-research register, and RFIG-025 fix methods and the failure-discussion firewall; research-data fitting still requires a separate clean-source execution decision |
