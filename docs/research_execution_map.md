...
| 5X. Exploratory protocol | Freeze and synthetically validate a post-Gate-5 exploratory implementation for Q01b projected quantum kernel and FQK feasibility-only quantum kernel only | D008 accepted and synthetic validation complete; D009 synthetic compute preflight accepted and pending 2026-07-13; research-data execution unauthorized | D008 fixes methods and guards. D009 freezes one clean-source q=8/two-layer/1,024-row synthetic benchmark, all matched controls, conservative campaign accounting, and pass/stop limits; a PASS can only support a later D010 decision |
