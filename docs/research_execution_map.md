...
| 5X. Exploratory protocol | Freeze and synthetically validate a post-Gate-5 exploratory implementation for Q01b projected quantum kernel and FQK feasibility-only quantum kernel only | D008 accepted and synthetic validation complete 2026-07-13; research-data execution unauthorized | The D008 YAML, implementation-freeze document, 30-row paired manifest, future-research register, RFIG-025, projected-kernel code, and synthetic tests fix methods and guards; research-data fitting still requires a separate clean-source compute preflight and execution decision |
