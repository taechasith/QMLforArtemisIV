...
| 5X. Exploratory protocol | Execute the accepted post-Gate-5 Q01b projected quantum kernel and FQK feasibility-only quantum kernel protocol under corrected fold-shape admission | D011 accepted conditionally; largest-fold synthetic preflight and development campaign outcome pending | D009 remains an immutable technical `STOP`, and D010 attempt 2 remains a valid closed PASS under its frozen shape. D011 requires a 1,024/9,750 synthetic bundle and conservative 1,220-unit projection before any development read. A PASS authorizes one resumable development-only campaign and RFIG-026 through RFIG-031; a STOP opens no payload. Calibration/final-test, hardware/GPU, Gate 5 reinterpretation, and Gate 6 remain locked |
