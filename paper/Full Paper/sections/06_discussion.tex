...
The paper's effect is therefore not a claim of operational benefit. It is a
reusable scientific pattern for high-consequence QML evaluation: include an
eligible simulator-validation scope, freeze data transformations and groups,
use a physics-aware control, compare against matched classical alternatives,
retain null outcomes, separate future protocol lessons from results, and use
claim boundaries that are mechanically checkable from source artifacts. This
pattern is valuable precisely because it makes an exciting but unsupported
result harder to publish.
