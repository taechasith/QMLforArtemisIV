...
\begin{longtable}{@{}p{0.09\textwidth}p{0.24\textwidth}p{0.15\textwidth}p{0.17\textwidth}p{0.25\textwidth}@{}}
\caption{Closed D034--D049 successor branch. Every row completed as a valid development-only negative. The C06 NRMSE was 0.006833 for each row. A negative paired difference favors the candidate over C06, but each branch also required its own frozen comparison and stopping rules.}\label{tab:successor-branch}\\
\toprule
