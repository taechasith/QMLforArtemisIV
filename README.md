...
approximately equivariant controls. It does not assume full SO(3) physical
symmetry, quantum advantage, improved sample-complexity scaling, classical
tensor explosion, or a simulation gap.
