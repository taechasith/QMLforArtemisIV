...
def main() -> None:
    ...
    definitions = [
        (
            ...
            "development_only_result",
            "AGEFRK q=4/6/8 and the identically gated two-RBF controls are compared with C06 under the frozen development-only rules.",
